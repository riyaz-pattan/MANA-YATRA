...
class MarkerGenerator {
  ...
  static Future<BitmapDescriptor> createDotMarker({
    ...
    final Path shadowPath = Path()
      ...
      ..moveTo(center.dx - 1.5, center.dy + radius)
      ..lineTo(center.dx + 1.5, center.dy + radius)
      ..lineTo(center.dx, center.dy + radius + stemHeight + 1)
      ..close();
  ...
  static Future<BitmapDescriptor> createLabelMarker({
    ...
    final double width = textPainter.width + iconSize + (padding * 3);
