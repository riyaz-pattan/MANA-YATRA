...
import 'package:gaman/repositories/ride_repository.dart';
import 'package:gaman/services/sync_engine.dart';
import 'package:gaman/models/queue_item.dart';
  ...
  group('FirestoreRideRepository (Rider)', () {
    ...
    test('acceptBid enqueues correct QueueItem', () async {
      ...
      final captured = verify(
        () => mockSyncEngine.enqueue(captureAny()),
      ).captured;
